...
All purchased parts are listed in [`hardware/bom_assembly.csv`](../hardware/bom_assembly.csv).
Print the four parts from [`hardware/enclosure/stl/`](../hardware/enclosure/stl/) first:
...
- Plug in USB-C and [flash the firmware](../firmware/) — see the README
  for flashing steps.
