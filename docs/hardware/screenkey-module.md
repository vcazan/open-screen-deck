...
Sources: [Waveshare product page (SKU 34168)](https://www.waveshare.com/0.85inch-screenkey.htm?sku=34168), [Waveshare docs](https://docs.waveshare.com/0.85inch-ScreenKey-Module-W), outline drawing (see below).
...
![Outline dimensions](../images/outline-dimensions.png)
